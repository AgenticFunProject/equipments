...
import { createBearerToken, type BearerAuthConfig } from "../auth.js";
...
import { auditedWrite, getCallerIdentity } from "./transport.js";
...
export function registerRoutes(app: FastifyInstance, options: ServerRoutesOptions): void {
  const { store, runtimeConfig, devMode, authConfig } = options;
