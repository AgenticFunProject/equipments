...
**YOU ARE IN: `equipments/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/equipments/` (rig root) or other directories
...
**Your mail address:** `equipments/polecats/furiosa`
**Your rig:** equipments
**Your Witness:** `equipments/witness`
...
| Ask Witness for help | `gt mail send equipments/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`equipments/witness`) when:
...
```bash
gt mail send equipments/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
